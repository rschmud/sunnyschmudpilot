...
class DRIVER_MONITOR_SETTINGS:
  def __init__(self):
    ...
    self._WHEELTOUCH_POLICY_ALERT_1_TIMEOUT = 2985.
    self._WHEELTOUCH_POLICY_ALERT_2_TIMEOUT = 2994.
    self._WHEELTOUCH_POLICY_ALERT_3_TIMEOUT = 3000.
    # https://cdn.euroncap.com/cars/assets/euro_ncap_protocol_safe_driving_driver_engagement_v11_a30e874152.pdf
    self._VISION_POLICY_ALERT_1_TIMEOUT = 1092.
    self._VISION_POLICY_ALERT_2_TIMEOUT = 1094.
